...
<!--[if gt IE 8]><!--> <html class="no-js" <?php language_attributes(); ?>> <!--<![endif]-->
  <head prefix="og: http://ogp.me/ns/website#"><!-- Prefix is used to declare facebook opengraph namespace for websites -->
    ...
    <!-- /build -->
    <link rel="stylesheet" href="<?php echo get_stylesheet_directory_uri(); ?>/fonts/stylesheet.css" type="text/css" charset="utf-8" />
    <!-- build:remove:compressed -->
	...
	<div class="u-gridContainer bot-line">
		...
		<div class="Mob-contact-ico">
			<a class="Button Button--transparent u-textInverted u-noLine telsvg" href="tel:075-6212580">
                ...
                <a class="Button Button--transparent u-textInverted u-noLine mailsvg" href="mailto:info@vanderwoude.nl">
				<svg class="Icon Icon--inline" viewBox="0 0 128 128">
