...
var isAndroidAndProductsPage = function(){
	var ua = navigator.userAgent.toLowerCase();
	var isAndroid = ua.indexOf("android") > -1; 
	
	//lamptypes || series
	var isProductPage = window.location.href.indexOf("series") > -1 ||  window.location.href.indexOf("lamptypes") > -1;
	return isAndroid && isProductPage;
}
var offsetW = 20;
var offsetH = 120;

if(isAndroidAndProductsPage()){
	offsetW = 80;
	offsetH = 220;
}

var winWidth  = jQuery(window).innerWidth()  - offsetW;
var winHeight = jQuery(window).innerHeight() - offsetH;
